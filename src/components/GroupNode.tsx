...
export function GroupNode({ id, data }: NodeProps<GroupNodeType>) {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-1 overflow-hidden rounded-md border border-dashed border-node-border bg-node px-3 py-1 font-mono">
      <Handle
        type="target"
